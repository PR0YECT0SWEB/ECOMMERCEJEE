				...
				<div class="col-sm-10 clearfix">
                                    ...
                                    <form action="ControlProducto" method="post">
                                        <div class="form-one">
                                            ...
                                            Precio:<input type="number" name="precio" placeholder="Precio" value="" min="0"/>
                                            Precio promo:<input type="number" name="precionuevo" placeholder="Precio" value="" min="0"/>
                                            ...
                                            Descripcion:<textarea name="descripcion" rows="4" cols="20" placeholder="Descripción" required>
                                            </textarea>
